...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S4( -9, -4,  0,  7), S4(  7,  2,  2, -3), S4(  9,  4, 11,  9), S4( -2,  4,  0,  1) },
   { S4(-24,-18, -6, -6), S4( -3,  1, -9, -7), S4( 16, 13, 10,  3), S4( 23, 18, 12,  4) },
   { S4(-15,-10, -1,  6), S4( -7, -7,  3,  4), S4( 20,  8, -3, -5), S4( 36, 19,  8, -3) },
   { S4( -9, -4,  6, 10), S4(  0,  7,  5, 11), S4(  3,  4,  4,  9), S4( 22, 14,  1, -4) },
   { S4( -5, -3,  0,  8), S4(-12, -6, -4, -1), S4( -5, -1,  0,  2), S4( -7,  0,  4,  8) },
   { S4( -1,  1,  9,  0), S4( 16,  4,  3, -6), S4( -8, -7, -2,  0), S4( -5,  4,  9, 19) }
  },
  { // Knight
