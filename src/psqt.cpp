...
Value PieceValue[PHASE_NB][PIECE_NB] = {
  { VALUE_ZERO, PawnValueOp, KnightValueOp, BishopValueOp, RookValueOp, QueenValueOp },
  { VALUE_ZERO, PawnValueMg, KnightValueMg, BishopValueMg, RookValueMg, QueenValueMg },
  { VALUE_ZERO, PawnValueEg, KnightValueEg, BishopValueEg, RookValueEg, QueenValueEg },
  { VALUE_ZERO, PawnValueLg, KnightValueLg, BishopValueLg, RookValueLg, QueenValueLg }
};
...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S4( -4, -5, -1,  3), S4(  9, -5,  1,  2), S4(  4,  8,  1,  6), S4(  2,  1,  6, 11) },
   { S4( -8,-23, -5, -9), S4(  0, -8, -3, -6), S4( 18, 17,  8, -5), S4( 10, 15, 12,  4) },
   { S4(-19,-11,  3,  8), S4(-16, -8, -2,  9), S4( 27, 15, -5,  0), S4( 35, 25,  4, -2) },
   { S4(  0,  8,  9, 17), S4(  8,  4, 12, 10), S4( 15,  7,  1,  0), S4( 20, 8, -6,-12) },
   { S4( -4, -6,  7, 14), S4( -1, -8,-11,  5), S4(-14, -7, 10,  7), S4( -5,  2,  8,  5) },
   { S4( -8, -7, -1, -2), S4( 23, 13,  6,  2), S4(-13, -6,  5, 15), S4( -9, 11, 19, 19) }
  },
  { // Knight
...
void init() {
  ...
  {
      PieceValue[OP][~pc] = PieceValue[OP][pc];
      PieceValue[MG][~pc] = PieceValue[MG][pc];
      PieceValue[EG][~pc] = PieceValue[EG][pc];
      PieceValue[LG][~pc] = PieceValue[LG][pc];

      Score v = make_score(PieceValue[OP][pc], PieceValue[MG][pc], PieceValue[EG][pc], PieceValue[LG][pc]);
