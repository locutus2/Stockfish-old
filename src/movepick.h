...
typedef Stats<int16_t, 29952, PIECE_NB, SQUARE_NB> PieceToKingHistory;
typedef Stats<PieceToKingHistory, NOT_USED, COLOR_NB, SQUARE_NB> KingHistory;
...
private:
  ...
  const PieceToKingHistory* kingHistory;
  Move ttMove;
