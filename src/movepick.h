...
/// CounterMoveHistory stores two counter moves indexed by [piece][to] of the previous
/// move, see chessprogramming.wikispaces.com/Countermove+Heuristic
typedef StatBoards<PIECE_NB, SQUARE_NB, std::array<Move, 2>> CounterMoveHistory;
...
public:
  ...
  MovePicker(const Position&, Move, Depth, const ButterflyHistory*, const CapturePieceToHistory*, const PieceToHistory**, const std::array<Move, 2>&, Move*);
...
private:
  ...
  Move ttMove, countermoves[2], killers[2];
