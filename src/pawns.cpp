...
namespace {
  ...
  Score evaluate(const Position& pos, Pawns::Entry* e) {
    ...
    Bitboard b, neighbours, stoppers, doubled, supported, phalanx, opposed;
    Square s;
    bool lever, connected, backward;
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if(opposed)
            b &= pawn_attack_span(Them, backmost_sq(Us, opposed) + pawn_push(Us));
