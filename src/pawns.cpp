...
namespace {
  ...
  const Value ShelterWeakness[][RANK_NB] = {
    { V(100), V(20), V(14), V(50), V(84), V( 87), V( 98) },
    { V(116), V( 4), V(35), V(92), V(97), V(109), V(104) },
    { V(109), V( 1), V(63), V(91), V(66), V( 92), V(116) },
    { V( 75), V(12), V(47), V(63), V(94), V( 85), V(112) }
  };
...
Value Entry::shelter_storm(const Position& pos, Square ksq) {
  ...
  Bitboard ourAttacks = pawn_attacks(Us);
  ...
  for (File f = center - File(1); f <= center + File(1); ++f)
  {
      ...
      if (rkUs != RANK_1 && (ourAttacks & make_square(f, relative_rank(Us, rkUs))))
          safety += 10;
  }
