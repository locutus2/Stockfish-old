...
MovePicker::MovePicker(const Position& p, Move ttm, Depth d, const HistoryStats& h, const GamePhaseStats& gph,
                       const CounterMovesStats& cmh, Move cm, Search::Stack* s)
           : pos(p), history(h), counterMovesHistory(&cmh), gamePhaseHistory(&gph), ss(s), countermove(cm), depth(d) {
...
MovePicker::MovePicker(const Position& p, Move ttm, Depth d,
           ...
           : pos(p), history(h), counterMovesHistory(nullptr), gamePhaseHistory(nullptr) {
...
MovePicker::MovePicker(const Position& p, Move ttm, const HistoryStats& h, Value th)
           : pos(p), history(h), counterMovesHistory(nullptr), gamePhaseHistory(nullptr), threshold(th) {
