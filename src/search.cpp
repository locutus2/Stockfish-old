...
//	     + nmpFailed - 2 * singularFailed - noLMRExtension;
	...
	//	      PARAM(depth),
			      ...
			      PARAM(givesCheck),
			      PARAM((type_of(movedPiece) == PAWN)),
			      PARAM((type_of(movedPiece) == KNIGHT)),
			      PARAM((type_of(movedPiece) == BISHOP)),
			      PARAM((type_of(movedPiece) == ROOK)),
			      PARAM((type_of(movedPiece) == QUEEN)),
