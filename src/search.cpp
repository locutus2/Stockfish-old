...
moves_loop: // When in check search starts from here
    ...
    auto countermoves = thisThread->counterMoves[pos.piece_on(prevSq)][prevSq];

    MovePicker mp(pos, ttMove, depth, &thisThread->mainHistory, &thisThread->captureHistory, contHist, countermoves, ss->killers);
