...
namespace {
  ...
  void update_all_stats(const Position& pos, Stack* ss, Move ttMove, Move bestMove, Value bestValue, Value beta, Square prevSq,
...
moves_loop: // When in check, search starts here
    ...
    */
    ...
    // If there is a move which produces search value greater than alpha we update stats of searched moves
        ...
        update_all_stats(pos, ss, ttMove, bestMove, bestValue, beta, prevSq,
