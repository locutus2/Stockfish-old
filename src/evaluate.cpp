...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score PassedKingProximity[COLOR_NB][RANK_NB][8] = {
    {
      {},
      { S(0, 0), S( 5,   1), S( 0,   1), S(-1,   1), S( 0,  -3), S( 0,  -1), S(-1,   8) , S( 2,   1) },
      { S(0, 0), S( 1,   3), S(-2,   5), S( 1,   8), S(10,   2), S( 1,  -2), S( 3,   2) , S(-1,   4) },
      { S(0, 0), S(-5,  13), S(-9,  30), S( 5,  49), S( 8,  64), S(-5,  73), S(-2,  66) , S( 3,  71) },
      { S(0, 0), S(-3,  29), S( 2,  61), S(-3,  88), S( 4, 122), S( 0, 158), S( 0, 154) , S( 3, 155) },
      { S(0, 0), S( 0,  61), S( 4, 121), S( 0, 183), S(-1, 240), S(-3, 306), S( 1, 305) , S(-2, 302) },
      { S(0, 0), S( 3, 103), S( 9, 211), S(-2, 311), S(10, 408), S(-2, 524), S( 7, 521) , S( 4, 526) }
    },
    {
      {},
      { S(0, 0), S(-4, -1), S(  1,   7), S( 4,   1), S( 2,   4), S(-1,  -1), S( 7,   5) , S( 0, -10) },
      { S(0, 0), S(10,  7), S(  1,  -2), S(-2,   0), S( 4,   0), S( 8,   7), S( 8,  -3) , S( 2,   6) },
      { S(0, 0), S(-4, -2), S(  4,  17), S(-1,  14), S(-5,  22), S(-5,  22), S(-3,  25) , S( 3,  27) },
      { S(0, 0), S(-2, 15), S(  5,  25), S( 7,  35), S( 4,  52), S( 6,  62), S(-1,  62) , S( 3,  53) },
      { S(0, 0), S( 1, 23), S(  1,  41), S(-1,  71), S(-4,  89), S(-3, 125), S( 0, 126) , S( 0, 120) },
      { S(0, 0), S(-2, 44), S(  7,  89), S( 8, 129), S( 4, 168), S( 3, 213), S(-7, 210) , S(-6, 214) }
    }
  };
