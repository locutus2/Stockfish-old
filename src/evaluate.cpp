...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score LowMobility        = S(  0, 10);
...
#undef S
  ...
  private:
    ...
    // lowMobilityCount[COLOR_NB] is the number of pieces with low mobility for the given color.
    int lowMobilityCount[COLOR_NB];
  };
