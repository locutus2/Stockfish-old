...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score MobilityBonus[][32] = {
    ...
    { S(-32,-39), S(-20,-17), S( -8,  2), S(  2, 20), S( 12, 36), S( 20, 50), // Queen
      S( 28, 63), S( 35, 74), S( 42, 85), S( 48, 94), S( 53,102), S( 58,109),
      S( 62,116), S( 67,121), S( 70,127), S( 74,132), S( 77,137), S( 81,141),
      S( 84,146), S( 87,151), S( 91,156), S( 94,161), S( 98,168), S(102,174),
      S(106,182), S(111,190), S(116,199), S(122,210) }
  };
