...
#undef S
  ...
  Value Evaluation<T>::value() {
    ...
    Score threatsScore = threats<WHITE>() - threats<BLACK>();
    score += make_score(mg_value(pos.this_thread()->contempt) * int(mg_value(threatsScore)) / 256,
                        eg_value(pos.this_thread()->contempt) * int(eg_value(threatsScore)) / 256);
