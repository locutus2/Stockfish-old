...
#undef S
  ...
  void Evaluation<T>::initialize() {
    ...
    constexpr Bitboard Corners  = (Us == WHITE ? make_bitboard(SQ_A8, SQ_H8)
                                               : make_bitboard(SQ_A1, SQ_H1));
    ...
    mobilityArea[Us] = ~(b | pos.pieces(Us, KING, QUEEN) | pe->pawn_attacks(Them) | Corners);
