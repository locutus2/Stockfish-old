   ...
   Score PassedKingProximity[COLOR_NB][RANK_NB][8] = {
    {
      ...
      { S(1, 1), S(1, 1), S(1, 1), S(1, 1), S(1, 1), S(1, 1), S(1, 1) , S(1, 1) },
      { S(1, 1), S(1, SC*5*3*1), S(1, SC*5*3*2), S(1, SC*5*3*3), S(1, SC*5*3*4), S(1, SC*5*3*5), S(1, SC*5*3*5) , S(1, SC*5*3*5) },
      { S(1, 1), S(1, SC*5*6*1), S(1, SC*5*6*2), S(1, SC*5*6*3), S(1, SC*5*6*4), S(1, SC*5*6*5), S(1, SC*5*6*5) , S(1, SC*5*6*5) },
      { S(1, 1), S(1, SC*5*12*1), S(1, SC*5*12*2), S(1, SC*5*12*3), S(1, SC*5*12*4), S(1, SC*5*12*5), S(1, SC*5*12*5) , S(1, SC*5*12*5) },
      { S(1, 1), S(1, SC*5*21*1), S(1, SC*5*21*2), S(1, SC*5*21*3), S(1, SC*5*21*4), S(1, SC*5*21*5), S(1, SC*5*21*5) , S(1, SC*5*21*5) } 
    },
    {
      {},
      { S(1, 1), S(1, 1), S(1, 1), S(1, 1), S(1, 1), S(1, 1), S(1, 1) , S(1, 1) },
      { S(1, 1), S(1, 1), S(1, 1), S(1, 1), S(1, 1), S(1, 1), S(1, 1) , S(1, 1) },
      { S(1, 1), S(1, SC*2*3*1), S(1, SC*2*3*2), S(1, SC*2*3*3), S(1, SC*2*3*4), S(1, SC*2*3*5), S(1, SC*2*3*5) , S(1, SC*2*3*5) },
      { S(1, 1), S(1, SC*2*6*1), S(1, SC*2*6*2), S(1, SC*2*6*3), S(1, SC*2*6*4), S(1, SC*2*6*5), S(1, SC*2*6*5) , S(1, SC*2*6*5) },
      { S(1, 1), S(1, SC*2*12*1), S(1, SC*2*12*2), S(1, SC*2*12*3), S(1, SC*2*12*4), S(1, SC*2*12*5), S(1, SC*2*12*5) , S(1, SC*2*12*5) },
      { S(1, 1), S(1, SC*2*21*1), S(1, SC*2*21*2), S(1, SC*2*21*3), S(1, SC*2*21*4), S(1, SC*2*21*5), S(1, SC*2*21*5) , S(1, SC*2*21*5) } 
    }
  };
