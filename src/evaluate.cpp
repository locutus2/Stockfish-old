...
Value Eval::evaluate(const Position& pos) {
  ...
  else
  {
      ...
      int   r50 = 7 + pos.rule50_count();
      bool  largePsq = psq * 7 > (NNUEThreshold1 + pos.non_pawn_material() / 64) * r50;
      ...
      if (   largePsq
          && (abs(v) * 7 < NNUEThreshold2 * r50
          || (   pos.opposite_bishops() 
              && abs(v) * 7 < (NNUEThreshold1 + pos.non_pawn_material() / 64) * r50
